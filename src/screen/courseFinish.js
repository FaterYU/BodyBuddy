...
import {Text, View, Dimensions, StyleSheet, FlatList, TouchableOpacity, TouchableHighlight, TouchableWithoutFeedback} from 'react-native';
...
const CourseFinish = ({navigation}) => {
    ...
    return(
        ...
        ListHeaderComponent={() => (
                <View style={{width:screenWidth+20,elevation:8  ,marginTop:-16 , marginBottom:36 ,paddingBottom:14 ,borderBottomRightRadius:24,borderBottomLeftRadius:24,justifyContent:'flex-end',alignItems:'center'}}>
                    <MaterialCommunityIcons name="chevron-left-circle" size={34} style={{alignSelf:'flex-start',marginTop:22,marginLeft:14,marginBottom:20}} color="rgba(190,190,190,0.8)" onPress={goToHome}/>
